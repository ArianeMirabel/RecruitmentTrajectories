...
\Abstract{
In the global changing context it is urgent to clarify the consequences
of disturbance on tropical forests diversity and composition. We
examined the diversity and composition trajectories of a neotropical
forest over 30 years in a Neotropical forest after a gradient of logging
and thinning disturbance, specifically focusing on recruitment processes
that determines all facets of forests resilience. We analysed the
trajectories of three major taxonomic diversities assessing communities
richness and evennes, of Rao functional diversity summerizing species
ecology through 7 key functional traits and of the recruitment taxonomic
nestedness compared to pre-disturbance communities. Stochastic models
were besides compared to recruitment trajectories to determine the
underlying ecological processes shaping communities response. We found
three-phased recruitment trajectories determined by the variable balance
between stochastic and deterministic processes. Trajectories first
relied on the stochastic recruitment of already grown saplings before
the deterministic recruitment of individuals from the seed bank selected
by interspecific competitive exclusion for light. Eventually stochastic
processes specific to old-growth, control communities were restored,
although taxonomic and functional recovery rates differed. The
trajectories demonstrated a fast functional resilience within a common
functional space and a slower taxonomic resilience maintaining initial
differences among communities. Our study highlighted the role of
deterministic processes for the recruitment response to disturbance
ensuring communities functional and taxonomic resilience, although the
decade-long recovery processes called to cautions regarding forest
