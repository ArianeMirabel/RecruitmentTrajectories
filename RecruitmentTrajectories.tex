...
to disturbance. Recruitment as major driver of forests trajectories is
crucial in that regard to highlight the underlying processes of forests
response. Through recruitment trajectories, clarify forests resilience
and recovery would come to (i) unravel the stochastic from deterministic
recruitment processes and (ii) specify the deterministic competition
rules involved in species selection, and finally (iii) resolve the time
to recover pre-disturbance recruitment processes and the completeness of
their resilience. We examined the trajectories of recruitment diversity
and composition in 70ha of a neotropical forest over 30 years after a
gradient of logging and thinning disturbance (from 15 to 60\% of AGB
removed). Specifically we analysed the trajectories of three taxonomic
diversities assessing communities richness and evennes, of Rao
functional diversity integrating species ecology through 7 key
functional traits, and of the species turnover of recruited trees
compared to pre-disturbance communities. Recruitment trajectories were
besides compared to null models of stochastic taxonomic and functional
recruitment. We found three-phased recruitment trajectories shaped by
the gradual balance between stochastic and deterministic processes.
Trajectories first relied on the stochastic recruitment of
pre-disturbance grown saplings. Then it relied on the deterministic
recruitment of \emph{true recruits} from the seed bank undergoing
competitive exclusion favoring acquisitive, light-demandings species. In
a third phase an inversed balance restored the stochastic recruitment
observed in mature forests and marked a return to communities initial
states. Recruitment trajectories entailed a fast recovery of the
functional diversity but a slower taxonomic recovery still unachieved
although it maintained composition differencies among plots. The
response to disturbance is a combination of deterministic and stochastic
processes, first altering recruits diversity and composition in favoring
light-demanding species, and then restoring pre-disturbance taxonomic
and functional structure through stochastic recruitment processes. Both
of the recruitment proved resilient, although the species composition of
pre-disturbance communities remained unachieved. Still, after 30 years
recruits' composition remained alter so if promising for the maintenance
of the multiple facets of forests biodiversity, these results called
cautions regarding the necessary time for forest recovery and the
resonse of repeated disturbance.
}
...
Major insights on the response of forests diversity to disturbance would
be given by the trajectories of tree communities along time. Communities
comprise on the one hand the trees surviving from before disturbance and
on the other hand those recruited afterward \citep{Herault2018}.
Surviving trees already proved to mirror the diversity and composition
of pre-disturbance communities, so the dynamics and the resilience of
...
communities resilience . Controversies remain about whether resilience
is determinisitc, and thus entails the convergence of communities
towards a given structure likely defined by the environment
\citep{Clements1916}, or stochastic, and thus entails communities
divergence through species random recruitment \citep{Diamond1975}.
Recently both points of view were reconciled under the hypothesis that
communities diverge in the taxonomic space while they converge in the
functional space, and therefore have a determined diversity and
...
trajectories involved an combination of stochastic and deterministic
recruitment based on competitive exclusion for resources, and eventually
restored initial recruitment processes.
...
according to their resource acquisition strategy, following
...
light-demanding and submitted to competitive exclusion, but their
...
The recruitment trajectories were identical in disturbed and untouched
areas, demonstreating the homogeneity of the recruitent processes in the
whole community. Indeed, in undisturbed forests the light availability
proved quite homogeneous and unrelated to trees recruitment success
\citep{Dalling2002}, while disturbance gaps and their edge effect
significantly increase the global enlightment and likely enhanced all
trees recruitment success \citep{Ruger2009}.
...
proved resilient but over a decades-long period.
...
equilibrium among communities, corresponding to the initial commmunities
restored after disturbance, in accordeance with the assumptions made for
...
composition that oriented the trajectories, consistently with other case
study and with the involvement of pre-disturbance grown saplings and
local seed bank \citep{Dalling2002, Anderson2007}.

In contrast the trajectories of some traits and global functional
diversity were essentially similar among treatments and recovered
quickly. This translated the convergence of communities in the
functional space and the fast recovery of communities functioning
despite their divergence in the taxonomic space \citep{Fukami2005}. This
...
competitive exclusion based on species light acquisition strategies.
After intense disturbance the second recruitment phase was dominated by
...
The recruitment response to disturbance demonstrated communities quick
functional resilience in a common functional space while it highlighted
the long-term taxonomic resilience, \emph{i.e.} several decades, that
...
management guidelines that aim to a complete recovery of ecosystems.
