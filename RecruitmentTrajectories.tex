...
then compared to a null random recruitment model. While in control plots
the richness and evenness of punctual recruits remained equivalent or
higher than for the null random model (Figure \ref{fig:Fig1}), in was
significantly lower for all disturbed plots all along the monitoring
period. Accumulated recruitment richness (order 0) and evenness (order
2) were higher or equivalent to those of the null model for plots T1 and
some plots T2 but lower for plots T3 and a plot T2 (AppendixI, fig. S1).
...
intensity. Disturbance increased the recruitment rate and thus also the
richness of recruited trees but in contrast impaired the recruitment
evenness, all the more so that disturbance intensity was high. Post
disturbance recruitment underwent significant selective pressure in
favour of acquisitive functional strategies, which steered the diversity
trajectories away from random processes and restricted the pool of
recruited trees that did not reflect the initial stand composition,
unlike the recruitment of control plots. The most intense disturbance
induced strong species selection that changed the recruitment rules and
makred plots composition and diversity for more than 30 years while less
disturbed plots displayed a faster recovery.
...
hump-shaped, unimodal trajectories. The 10-15 first years of these
trajectories seemed driven by the growth of pre-disturbance saplings
benefitting from the environmental changes and alleviated competition
following disturbance \citep{Herault2010}. This translated first by a
stable functional diversity of the recruitment, equivalent as this of
control plots, and low difference to random null model, specifically for
low disturbance intensities. After the most intense disturbance this
translated by a sharp increase of SLA and bark thickness values
reflecting the dominance of short-lived pionneers capable of effective
light acquisition and fast growth (Figure \ref{fig:Fig4})
...
the disturbance, which underwent competition for light resources.
Different trajectories were then observed according to the disturbance
intensity. In the case of low disturbance intensity (T1 plots), although
the recruitment resembled the pre-disturbance species composition, it
displayed decreasing eveness compared to control plots and random
models. This revealed selective pressures and competition for resources
leading to an increase in functional diversity, equating or exceeding
this of control plots, and an overdispersion of functional traits
compared to a null random model. This competition benefited pioneers and
light demanding species preserved from the overwhelming settlement of
hard pioneers by recruitment limitation
\citep{Hubbell1999, Sheil2003, Bongers2009}. Recruitment limitation of
hard pioneers that mitigated competitive exclusion and maintained
...
very high after the initial 10 year phase and the functional diversity
decreased sharply towards a restricted range of acquisitive functional
strategies.\\
This translated by a decrease in leaf thoughness, Wood Specific Gravity
and Hmax from the incorporation of long-lived pioneers.
