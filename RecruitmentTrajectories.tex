...
recognized to follow deterministic successional pathways. These pathways
however might be altered in the hyper-diverse tropical forests and might
not apply in cases of insiduous global changes. Examine post-disturbance
...
disturbance gradient. Specifically, we analysed recruitment taxonomic
richness, evennes, taxonomic turnover, and functional diversity and
composition regarding 7 leaf, stem and life-history functional traits.
We highlighted a three-phased deterministic successional pathway defined
...
a disturbance intensity threshold, and (iii) a return towards
