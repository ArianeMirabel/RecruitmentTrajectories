...
theory of succession assumes predictable post-disturbance trajectories
shaped by deterministic recruitment processes
\citep{Clements1916, Meiners2015}. However, the specific processes
underlying these trajectories remain to be disentangled, which is
essential to highlight community structuring mechanisms and improve
exploitation and conservation guidelines \citep{Diaz2005, Meiners2015}.

In forest ecosystems, the successional framework translates first into
the recruitment of saplings benefiting from the available resources and
the low competition, then into the progressive exclusion of
low-competitive species with the stand maturation and the increasing
competition for resources, and eventually into the senescence of
early-successional and the emergence of late-successional species
restoring community pre-disturbance composition and diversity
\citep{Denslow2000}. This deterministic succession involves a gradual
recovery of pre-disturbance state through various recruitment processes
depending on species resource use and competitive abilities
\citep{Chesson2000, Rees2001, Adler2007}. Observations, however, show
that post-disturbance trajectories can result from the interplay between
deterministic and stochastic processes. Stochastic processes would imply
a random recruitment of species, depending on dispersal limitations, and
no resilience of the pre-disturbance state
\citep{Hubbell2001, Chave2004, Norden2015}. The balance between
deterministic and stochastic processes remain specifically questioned in
tropical forests, where the diversity is huge and the long-term
monitoring are scarce \citep{Sebbenn2008, Schwartz2017}. It is essential
to understand the balance between deterministic and stochastic processes
and its changes along time after disturbance, to understand and
anticipate post-disturbance diversity patterns \citep{Norden2017}.

The underlying processes of post-disturbance trajectories affect both
community taxonomic characteristics, that refer to neutral species
...
\citep{Clements1916, Diamond1975}. The interplay between deterministic
and stochastic processes might then translate into a divergence in the
taxonomic space, with communities displaying different taxonomic
composition and diversity, and a converge in the functional space
