...
validity of recruitment processes for the whole whole plot scale.-> I do not see those results in the current ms.
...
was a random sampling of ?surviving? individual trees according to their observed
...
trait values among species that ??? not clear?? randomizes abundances across species but
within communities \citep{Mason2013}.
...
not restricted to logging gaps. -> may be omitted thus
...
\citep{Ruger2009}.
-> to be matched with what written here before
...
trajectories, revealing three distinct recruitment phases.
...
strategy, and balanced the stochastic recruitment observed
...
pre-disturbance communities but recruited species include more pioneers and
...
overhelming recruitment of hard pioneers, such as Cecropia spp. likely entailing significant
...
diversity meant the long-term maintenance of the pre-disturbance taxonomic differences between
