...
response of community diversity and composition to disturbance.
Community response to disturbance rely on tree recruitment that is
recognized to follow deterministic successional pathways. These however
might be altered by the high diversity tropical forests and might not
pply in cases of insiduous global changes. Examine post-disturbance
recruitment trajectories would (i) disentangle stochastic and
deterministic, selective recruitment processes underlying
post-disturbance community response, and (ii) elucidate the taxonomic
and functional resilience pf tropical forests. We examined the
trajectories over 30 years of recruited trees taxonomic and functional
diversity in 75 ha of a neotropical forest following a disturbance
gradient. Specifically, we analysed recruited trees taxonomic richness,
evennes, and compositional turnover and their functional diversity and
composition regarding 7 leaf, stem and life-history functional traits.
We highlighted a three-phase deterministic successional pathway defined
by the interplay of stochastic and deterministic recruitment processes.
The successional pathway translated into (i) the growth of saplings
mirroring the pre-disturbance community, (ii) the selective recruitment
of light-demanding species entailing a high dominance of pioneers above
an disturbance intensity threshold, and (iii) a return towards
pre-disturbance taxonomic and functional characteristics with the
recovery of stochastic recruitment processes. Both recuited trees
functional and taxonomic characteristic seemed resilient, but the
...
processes for light balancing the stochastic processes rueling
...
which called cautions regarding forest management practices.
}
...
litterature successfully modeled communities response to disturbance in
...
recovery of community diversity and composition after disturbance is
determined by recruitment processes, thus post-disturbance trajectories
would help adjusting exploitation and conservation guidelines
...
competitive ability because of the increase of competition for resources
...
their high functional redundancy leading up to more stochatic processes.
Moreover, the successional pathway proved well-adapted to system
trajectories following clear cutting or very intense disturbance, but it
might be less robust following more insidious global changes. In those
cases, community trajectories would depend on the interplay between the
stochastic processes, driven by recruitment and dispersal limitations
\citep{Hurtt1995, Hubbell2001}, and deterministic processes, driven by
...
trajectories would also change with time as the pre-disturbance
environmental conditions are progressively restored.
...
The determinism of post-disturbance recruitment further elucidates the
random divergence of post-disturbance trajectories, or their convergence
towards stable taxonomic and functional characteritics, likely defined
by the environment \citep{Clements1916, Diamond1975}. Both views were
reconciled under the hypothesis that communities might diverge in the
taxonomic space, and have different taxonomic composition and diversity,
...
community taxonomic and functoinal resilience and their consequences for
forest management..
...
5 to 50 m and mean annual temperature is 26 \textdegree C. Soils are
thin acrisols over a layer of transformed saprolite with low
permeability generating lateral drainage during heavy rains. The
experiment is a network of twelve 6.25ha plots (Table \ref{tab:Tab1})
that underwent three disturbance treatments in 1987 according to a
randomized plot design with three replicate blocks of four plots
\citep{Herault2018}.
...
carrying each value \citep{Diaz2007, Garnier2004, Mason2013}. Seed mass
trajectories were reported by the proportion of each class recorded in
the inventories (Annexe I).
...
years and positively correlated to the disturbance intensity (XXX
spearman). Afterward the taxonomic richness decreased and recovered the
pre-disturbance values after 30 years. The taxonomic richness trajectory
was increasingly lower than this of null model until 15 years, then the
difference started to shrink but the recruitment richness remained lower
than this of the null model after 30 years. The taxonomic evenness
decreased independently of the disturbance intensity over the 30 years
and was increasingly lower than this of the null model for 15 years
after disturbance when the difference stabilized.
...
disturbance before recovering towards initial values and was lower than
this of the null model.
...
SLA and bark thickness first increased before decreasing to recover
initial values, while trajectories of leaf thickness, leaf toughness,
wood specific gravity, and maximum heigt first decreased and then
started returning towards initial values but their recovery remained
unachieved after 30 years (Figure \ref{fig:CWM}).
...
Over the 30 years in control plots the recruited species turnover
...
disturbance intensity (\(\rho_{spearman}=0.93\)). After thirty yearsthe
turnover of all disturbed plots had returned to low values.
...
Post-disturbance recruitment trajectories rely on a three-phased
succession pathway shaped by the emergence of deterministic competition
processes for light gradually balancing the stochastic recruitment
specific to undistubed communities.

In a first phase (0-8 years), recruitment likely pre-disturbance
surviving saplings (DBH \textless{} 10cm) that immediately benefited
from the increased enlightment and the alleviated competition induced by
disturbance \citep{Denslow2000, Herault2010}. The taxonomic and
functional characterisitcs of recruited trees mirrored the
pre-disturbance communities and the recruitment processes corresonded to
...
strategies and the dominance within recruited trees of a restricted set
of species. Recruits then likely corresponded to true recruits,
\emph{i.e.} trees germinated from the seeds bank, that eventually are
the main part of the whole post-disturbance recruitment
\citep{Lawton1988}. Recruited trees were then dominated by short-lived,
fast growing hard pionneer species with competitive and efficient light
acquisition \citep{Wright2004, Chave2009b, Herault2011, Reich2014}. As
already demonstrated in temperate forests, competition processes
restricted the pool of recruited species in enhancing the selection of
species with efficient light acquisition strategy
...
the first place, and the relative importance of both recruitment
processes was determined by the disturbance intensity. After low
intensity disturbance (T1 plots) recruited species still mirrored the
taxonomic composition of pre-disturbance communities, but included more
included long-lived pioneers and light-demanding species with strategies
of efficient resource acquisition (high SLA and leaf chlorophyll
content) and inexpensive, short-lived tissues (low leaf thickness and
thoughness, small Hmax and low wood specific gravity and bark thickness)
...
recruited species remained mainly light-demanding their functional
diversity increased and their taxonomic composition increasingly
resembled pre-disturbance community. The deterministic recruitment
processes then gradually left room to the recovery of the stochastic
recruitment processes specific to undisturbed forest
...
After disturbance the stochastic recruitment processes of undisturbed
communities progressively recovered, drivingy the recovery of community
taxonomic and functional convergence.

Recruited trees taxonomic richness and evenness recovered
pre-disturbance values and their taxonomic composition converged towards
the pre-disturbance community, thus maintaining the initial taxonomic
differences among communities. Even after intense disturbance entailing
significant changes in the forest structure and the recruitment of hard
pioneers community taxonomy was resilient. The high resilience of
...
The recovery of recruited trees functional diversity and composition and
the similarity of the recruitment trajectories in the functional space
suggested a common and resilient functioning despite taxonomic
differences among communities \citep{Fukami2005}. This confirmed
...
composition had been detected.

Although resilient, the functional and taxonomic composition of
recruited trees remained altered after 30 years by the dominance of more
light-demanding species than in undisturbed forests. This long-term
impact specifically raises questions in the context of forest
exploitation, where most valuable species are late-successional species,
and thus require cutting cycles of more than 30 years \citep{Putz2012}.
...
undisturbed communities. The successional pathway first translated into
