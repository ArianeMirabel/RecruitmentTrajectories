...
Regarding tree community diversity and composition, the ecological theory of succession assumes predictable post-disturbance trajectories shaped by deterministic recruitment processes [@Clements1916;@Meiners2015].
However, the specific processes underlying these trajectories remain to be disentangled, which is essential to highlight community structuring mechanisms and improve exploitation and conservation guidelines [@Diaz2005;@Meiners2015].

In forest ecosystems, the successional framework translates first into the recruitment of saplings benefiting from the available resources and the low competition, then into the progressive exclusion of low-competitive species with the stand maturation and the increasing competition for resources, and eventually into the senescence of early-successional and the emergence of late-successional species restoring community pre-disturbance composition and diversity [@Denslow2000].
This deterministic succession involves a gradual recovery of pre-disturbance state through various recruitment processes depending on species resource use and competitive abilities [@Chesson2000;@Rees2001;@Adler2007].
Observations, however, show that post-disturbance trajectories can result from the interplay between deterministic and stochastic processes.
Stochastic processes would imply a random recruitment of species, depending on dispersal limitations, and no resilience of the pre-disturbance state [@Hubbell2001;@Chave2004;@Norden2015].
The balance between deterministic and stochastic processes remain specifically questioned in tropical forests, where the diversity is huge and the long-term monitoring are scarce [@Sebbenn2008;@Schwartz2017].
It is essential to understand the balance between deterministic and stochastic processes and its changes along time after disturbance, to understand and anticipate post-disturbance diversity patterns [@Norden2017].

The underlying processes of post-disturbance trajectories affect both community taxonomic characteristics, that refer to neutral species assemblages, and functional characteristics, that account for species ecology and functioning [@Macarthur1967;@Violle2007b;@Kunstler2016].
The different ecological processes can be assessed through the taxonomic and functional diversity and composition of recruited communities following disturbance [@Fukami2005;@Chalmandrier2015;@Cequinel2018].
A determinisitic succession thus imply predictable recruitment trajectories comprising a succession of recruitment processes based on species competitive ability [@Rees2001;@Perronne2017].
In tropical forests, light is the limiting resource: post-disturbance trajectories would be shaped by a shift from slow-growing, long-lived species with "conservative" resource use, to fast-growing species with "acquisitive" resource use [@Denslow1980;@Molino2001;@Bongers2009].  
...
The balance between deterministic and stochastic processes would translate in a random divergence of both community trajectories, contrasting with a deterministic convergence towards the recovery pre-disturbance state [@Clements1916;@Diamond1975].
The interplay between deterministic and stochastic processes might then translate into a divergence in the taxonomic space, with communities displaying different taxonomic composition and diversity, and a converge in the functional space [@Fukami2005;@Li2018].
...
The recruitment was dominated by short-lived, fast growing hard pioneers displaying efficient light acquisition [@Wright2004;@Chave2009b;@Herault2011].
