...
Similar approaches regarding forest diversity and composition remain hindered by the scarcity of long-term monitoring and by studies' restriction to common or commercial species imposed by forest huge biological diversity [@Sebbenn2008;@Vinson2015].
...
Recruitment trajectories therefore give valuable insight into post-disturbance recovery and hence into the adjustment of exploitation and conservation guidelines [@Diaz2005;@Schwartz2017].
...
The correlations, or not, between community taxonomic and functional trajectories are therefore insightful of the processes underlying species recruitment [@Fukami2005].
Competitive interactions among species indeed depend on their competitive ability and ecological niche, defined by their functional differences regarding the use of limited shared resources [@Perronne2017].
...
mtext("Years since disturbance",side=1,adj=1,outer=T,line=-2,cex=1.5)
mtext("Equivalent diversity",side=2,line=1,cex=1.5)
...
The recruitment was dominated by short-lived, fast growing hard pionneers highly competitive and displaying efficient light acquisition [@Wright2004;@Chave2009b;@Herault2011].
